          ...
          <div className="w-full mt-2">
            ...
            <div className="mt-6 text-center">
              <p className="text-white/30 text-[12px] leading-relaxed mb-6">
                ...
                <Link
                  href="/terms"
                  className="text-white/50 hover:text-white transition-colors underline underline-offset-2 hover:underline-offset-4"
                >
                  Terms
                </Link>{" "}
                and{" "}
              ...
              <p className="text-white/40 text-[13px]">
                 Already have an account? <Link href="/sign-in" className="text-white hover:text-white/80 underline underline-offset-2">Sign in</Link>
              </p>
            </div>
          </div>
        </div>
