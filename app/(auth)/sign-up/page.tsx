            ...
            <SignUp
              ...
              appearance={{
                ...
                elements: {
                  ...
                  formButtonPrimary: "bg-white text-black hover:bg-white/90 rounded-lg font-semibold transition-all h-12 text-[15px] shadow-[0_0_20px_rgba(255,255,255,0.15)] mt-2 flex items-center justify-center w-full",
                  ...
                  footerAction: "bg-white/5 border border-white/10 rounded-lg p-4 mt-6 w-full flex items-center justify-center text-[13px]",
                  identityPreview: "bg-white/5 border border-white/10 rounded-lg p-3 w-full",
