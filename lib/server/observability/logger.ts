...
/**
 * Log a latency measurement for a specific phase of a request.
 *
 * Use this for per-phase timing (e.g. preflight, context_build, inference)
 * alongside `logRequest()` for the total duration.
 */
