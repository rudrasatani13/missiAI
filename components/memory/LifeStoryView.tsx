...
export function LifeStoryView() {
  ...
  return (
    <main className="min-h-screen bg-black text-white p-4 md:p-8 flex flex-col relative overflow-hidden">
      ...
      <header className="mb-6 flex flex-col md:flex-row md:items-end justify-between gap-4 relative z-10 w-full max-w-6xl mx-auto">
        <div>
          <div className="flex items-center gap-3 mb-2">
            <h1 className="text-3xl font-medium tracking-tight">Life Story</h1>
        ...
        <div className="flex items-center gap-4">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-full text-xs font-medium transition-all hover:scale-105 border border-white/10 bg-white/5 hover:bg-white/10 text-white/80"
          >
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto flex-1 flex flex-col">
        ...
        <div className="flex items-center gap-2 mb-6 overflow-x-auto pb-2 scrollbar-hide">
          <Link
            href="/memory/graph"
            className="flex-shrink-0 flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium transition-colors border border-white/10 bg-transparent text-white/60 hover:text-white hover:bg-white/5"
          >
        ...
        {/* Content Area */}
        <div className="flex-1 w-full relative rounded-2xl border border-white/10 bg-black/40 backdrop-blur-xl overflow-hidden min-h-[600px] shadow-2xl flex flex-col">
